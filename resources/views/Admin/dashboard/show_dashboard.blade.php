    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <canvas id="DoughnutChart" style="max-width: 100%; max-height: 200px;"></canvas>
                </div>
...
<script>
    ...
    new Chart(lineCtx, {
        type: 'line',
        data: {
            labels: @json($labels), // Labels for the X-axis (Months)
            datasets: [{
                label: 'Revenue',
...
<script>
    ...
    new Chart(doughnutCtx, {
        type: 'doughnut',
        data: {
            labels: @json($labels), // Labels for the doughnut chart (Months)
            datasets: [{
                label: 'Number of Orders',
                data: @json($orderCounts), // Number of orders data
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
