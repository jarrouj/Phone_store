...
<div class="modal fade" id="exampleModal{{ $data->id }}" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('/admin/update_product/' . $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <img src="/product/{{ $data->img }}" width="100px" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="price" class="form-control" required value="{{ $data->price }}" step="any">
                    </div>
